(ns kotoba.si.s-param-test
  "Parity tests for `kotoba.si.s-param`, ported from the `#[cfg(test)]`
  module in kami-si's `s_param.rs` (kotoba-lang/kami-engine, retired
  Rust crate, ADR-2607010000)."
